...
//  or modifying the list itself. Because of this, 
//  knowing how to traverse a linked list is paramount to being able to solve these questions. 
//  When traversing a linked list, 
//  the only reference you have to start is the head (or beginning) of the list. 
//  From the head you must continue traversing 
//  while you have not encountered a null node (i.e. the end of the list). 
//  Traversing the entirety of a linked list goes as follows: